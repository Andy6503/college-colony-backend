...
class TextbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create textbook" do
    assert_difference("Textbook.count") do
      post textbooks_url, params: { textbook: { message: @textbook.message, user_id: @textbook.user_id } }, as: :json
    end
  ...
  test "should update textbook" do
    patch textbook_url(@textbook), params: { textbook: { message: @textbook.message, user_id: @textbook.user_id } }, as: :json
    assert_response :success
  end
